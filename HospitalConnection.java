...
public class HospitalConnection {
    ...
    public int UpdateStatement(String table, String column_newValue, String condition){
        ...
        try {
            connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWD);
            statement = connection.createStatement();
            rowsEffected = statement.executeUpdate("UPDATE " + table + " SET "+ column_newValue + " WHERE " + condition);
